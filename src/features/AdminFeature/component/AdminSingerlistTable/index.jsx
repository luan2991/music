...
const columns = [
  { id: 'image', label: 'Ảnh ca sĩ/nhóm nhạc', minWidth: 100 },
  { id: 'name', label: 'Tên ca sĩ/nhóm nhạc', minWidth: 240 },
  {
    id: 'createdAt',
    label: 'Ngày tạo',
    minWidth: 100,
...
AdminSingerlistTable.propTypes = {
...
function AdminSingerlistTable(props) {
  const {
    page,
    rowsPerPage,
    handleChangePage,
...
export default AdminSingerlistTable;
